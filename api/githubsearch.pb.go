...
func (x *SearchRequest) Reset() {
	*x = SearchRequest{}
	mi := &file_api_githubsearch_proto_msgTypes[0]
...
func (*SearchRequest) Descriptor() ([]byte, []int) {
	return file_api_githubsearch_proto_rawDescGZIP(), []int{0}
}
...
func (x *SearchResponse) Reset() {
	*x = SearchResponse{}
	mi := &file_api_githubsearch_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SearchResponse) Descriptor() ([]byte, []int) {
	return file_api_githubsearch_proto_rawDescGZIP(), []int{1}
}
...
func (x *Result) Reset() {
	*x = Result{}
	mi := &file_api_githubsearch_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Result) Descriptor() ([]byte, []int) {
	return file_api_githubsearch_proto_rawDescGZIP(), []int{2}
}
...
var File_api_githubsearch_proto protoreflect.FileDescriptor
...
var (
	...
	file_api_githubsearch_proto_rawDescData []byte
)

func file_api_githubsearch_proto_rawDescGZIP() []byte {
	file_api_githubsearch_proto_rawDescOnce.Do(func() {
		file_api_githubsearch_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_githubsearch_proto_rawDesc), len(file_api_githubsearch_proto_rawDesc)))
	})
	return file_api_githubsearch_proto_rawDescData
}
...
func init() { file_api_githubsearch_proto_init() }
func file_api_githubsearch_proto_init() {
	if File_api_githubsearch_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_githubsearch_proto_rawDesc), len(file_api_githubsearch_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_api_githubsearch_proto_goTypes,
		DependencyIndexes: file_api_githubsearch_proto_depIdxs,
		MessageInfos:      file_api_githubsearch_proto_msgTypes,
	}.Build()
	File_api_githubsearch_proto = out.File
	file_api_githubsearch_proto_goTypes = nil
	file_api_githubsearch_proto_depIdxs = nil
}
